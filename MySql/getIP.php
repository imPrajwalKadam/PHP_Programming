          ...
          <form id="regform"name="regform" method="POST" action="">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                ...
                <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Enter a mobile number" require />
              </div>
            ...
            <div style="float: left;">
              <div class="on-focus clearfix" id="otpDiv" style="position: relative; display: none;">
                <input type="text" id="userOtp" name="userOtp" placeholder="OTP" />
              </div>
            </div>
            ...
            <div style="float: left;">
              <div id="otpDiv" style="position: relative; display: none;">
                <input type="text" id="userOtp" name="userOtp" placeholder="OTP" />
              </div>
            </div>
          </form>
...
<script type="text/javascript">
  ...
  function sendOtp() {
    ...
    var fname=document.regform.pName.value;
